 ...
 */
public class W531fBIntroFrag4 extends SlideFragment {

    public W531fBIntroFrag4() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_w531f_b_intro_frag4, container, false);
        ...
        if(savedInstanceState == null){
            programNameEditText.setText("Wendler 5-3-1 4B");
        }
    ...
    public boolean canMoveFurther() {
        ...
        if(!programNameEditText.getText().toString().isEmpty()){
            ...
            W531fBSingleton.getInstance().mRestTime =
                    minutesEditText.getText().toString() + ":" + secondsEditText.getText().toString();
            W531fBSingleton.getInstance().mIsActiveRestTimer = restTimerSwitch.isChecked();
            W531fBSingleton.getInstance().mVibrationTime = secondsVibrateEditText.getText().toString();
            W531fBSingleton.getInstance().mIsRestTimerAlert = showRestTimerAlertRB.isChecked();
            valuesEntered = true;
        }
