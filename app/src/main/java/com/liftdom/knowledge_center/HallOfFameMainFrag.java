 ...
 */
public class HallOfFameMainFrag extends Fragment {


    public HallOfFameMainFrag() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_hall_of_fame_main, container, false);

        headerChanger("Hall of Fame");
